                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" 
                                  id="content" name="content" rows="8">{{ old('content', $course->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('video_url') is-invalid @enderror" 
                               id="video_url" name="video_url" value="{{ old('video_url', $course->video_url) }}" 
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="text-center">
                                <h4 class="text-success">{{ $course->student_count }}</h4>
                                <small class="text-muted">Estudiantes</small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                                <h4 class="text-warning">{{ $course->payments()->where('status', 'completed')->count() }}</h4>
                                <small class="text-muted">Compras</small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                                <h4 class="text-info">{{ $course->created_at->format('d/m/Y') }}</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('duration') is-invalid @enderror" 
                               id="duration" name="duration" value="{{ old('duration', $course->duration) }}" min="1">
                        @error('duration')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3" id="price-section">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                   id="price" name="price" value="{{ old('price', $course->price) }}" min="0" step="0.01">
                        </div>
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="cover_image" class="form-label">
                            {{ $course->cover_image ? 'Nueva Imagen de Portada' : 'Imagen de Portada' }}
                        </label>
                        ...
                        @enderror
                        <div class="form-text">
                            {{ $course->cover_image ? 'Deja vacío para mantener la imagen actual.' : '' }}
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ route('admin.courses.lessons', $course) }}" class="btn btn-info">
                        <i class="fas fa-list me-2"></i>Gestionar Lecciones
                    </a>
                </div>
